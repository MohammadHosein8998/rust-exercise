...
fn choose_best_place_to_say() -> impl  Accommodation + Description {
    Hotel::new("the Luxe")
}
...
fn mix_and_match<T , U >(first: &mut T, second: &mut U, guest: &str) where 
...
fn main() {
    let mut hotel = choose_best_place_to_say();
